...
local config = {
    ...
    blocks = {
        start   = "minecraft:white_wool",       -- optional (turtle will move forwards each step regardless, only useful for debugging)
        turnAround = "minecraft:red_wool",       -- required
        finish  = "minecraft:orange_wool",        -- required

        emptyInventory = "minecraft:chest",      -- required
